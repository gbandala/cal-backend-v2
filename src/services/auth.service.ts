 ...
 * 4. Crear disponibilidad predeterminada (L-V 9AM-5PM)
  ...
  const availability = availabilityRepository.create({
    ...
    days: Object.values(DayOfWeekEnum).map((day) => {
      return dayAvailabilityRepository.create({
        ...
        // Usa fecha fija (2025-03-01) como base, solo importa la hora
        startTime: new Date(`2025-03-01T09:00:00Z`), // 9:00 AM UTC
        endTime: new Date(`2025-03-01T17:00:00Z`),   // 5:00 PM UTC
